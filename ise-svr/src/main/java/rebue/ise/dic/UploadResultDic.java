 ...
 * -1: 上传失败
 */
public enum UploadResultDic implements EnumBase {
    /**
     * 1: 上传成功
     */
    SUCCESS(1),
     ...
     */
    @JsonCreator
    public static UploadResultDic getItem(int code) {
        EnumBase result = valueMap.get(code);
        if (result == null) {
            throw new IllegalArgumentException("输入的code" + code + "不在枚举的取值范围内");
        }
        return (UploadResultDic) result;
    }
